        ...
        pub mod monotonic_clock {
            ...
            pub fn now() -> Mark {
                unsafe {
                    ...
                    unsafe extern "C" {
                        ...
                        fn wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0_rc_2026_02_09X00now() -> i64;
                    }
                    let ret = wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0_rc_2026_02_09X00now();
                    ret as u64
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            ...
            pub fn get_resolution() -> Duration {
                unsafe {
                    ...
                    unsafe extern "C" {
                        ...
                        fn wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0_rc_2026_02_09X00get_resolution() -> i64;
                    }
                    let ret = wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0_rc_2026_02_09X00get_resolution();
                    ret as u64
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            ...
            pub async fn wait_until(when: Mark) -> () {
                unsafe {
                    ...
                    unsafe extern "C" {
                        #[allow(non_snake_case)]
                        #[cfg_attr(target_arch = "wasm32", link_name = "wait-until")]
                        fn wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0_rc_2026_02_09X00wait_untilA(
                            _: i64,
                        ) -> *mut u8;
                    }
                    wit_bindgen::rt::async_support::await_result(move || unsafe {
                            wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0_rc_2026_02_09X00wait_untilA(
                                _rt::as_i64(when),
                            )
                        })
                        .await;
            ...
            pub async fn wait_for(how_long: Duration) -> () {
                unsafe {
                    ...
                    unsafe extern "C" {
                        #[allow(non_snake_case)]
                        #[cfg_attr(target_arch = "wasm32", link_name = "wait-for")]
                        fn wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0_rc_2026_02_09X00wait_forA(
                            _: i64,
                        ) -> *mut u8;
                    }
                    wit_bindgen::rt::async_support::await_result(move || unsafe {
                            wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0_rc_2026_02_09X00wait_forA(
                                _rt::as_i64(how_long),
                            )
                        })
                        .await;
            ...
            pub fn now() -> Instant {
                unsafe {
                    ...
                    unsafe extern "C" {
                        #[allow(non_snake_case)]
                        #[cfg_attr(target_arch = "wasm32", link_name = "now")]
                        fn wasiX3AclocksX2Fsystem_clockX400X2E3X2E0_rc_2026_02_09X00now(
                            _: *mut u8,
                        );
                    }
                    wasiX3AclocksX2Fsystem_clockX400X2E3X2E0_rc_2026_02_09X00now(ptr0);
            ...
            pub fn get_resolution() -> Duration {
                unsafe {
                    ...
                    unsafe extern "C" {
                        #[allow(non_snake_case)]
                        #[cfg_attr(target_arch = "wasm32", link_name = "get-resolution")]
                        fn wasiX3AclocksX2Fsystem_clockX400X2E3X2E0_rc_2026_02_09X00get_resolution() -> i64;
                    }
                    let ret = wasiX3AclocksX2Fsystem_clockX400X2E3X2E0_rc_2026_02_09X00get_resolution();
                    ret as u64
                }
            }
        }
...
#[unsafe(
    link_section = "component-type:wit-bindgen:0.53.1:wasi:clocks@0.3.0-rc-2026-02-09:imports:encoded world"
)]
#[doc(hidden)]
...
ution\x01\x05\x03\0,wasi:clocks/system-clock@0.3.0-rc-2026-02-09\x05\x03\x04\0'w\
asi:clocks/imports@0.3.0-rc-2026-02-09\x04\0\x0b\x0d\x01\0\x07imports\x03\0\0\0G\
