...
(cd import/src; ../../../../wit-bindgen/target/debug/wit-bindgen rust ../../wit -w imports --symmetric --link-name wasi_clocks_symmetric --format && mv imports.rs imports_symmetric.rs)
