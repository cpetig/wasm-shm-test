    ...
    pub mod wasi {
        pub mod clocks {
            ...
            pub mod monotonic_clock {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_async_wait_until_cabi<T: Guest>(arg0: i64) -> i32 {
                    unsafe {
                        #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                        wit_bindgen::rt::async_support::start_task(async move {
                            ...
                            #[link(
                                wasm_import_module = "[export]wasi:clocks/monotonic-clock@0.3.0"
                            )]
                            unsafe extern "C" {
                                #[allow(non_snake_case)]
                                #[cfg_attr(
                                    target_arch = "wasm32",
                                    link_name = "[task-return][async]wait-until"
                                )]
                                fn X5BexportX5DwasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0X00X5Btask_returnX5DX5BasyncX5Dwait_until();
                            }
                            _task_cancel.forget();
                            X5BexportX5DwasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0X00X5Btask_returnX5DX5BasyncX5Dwait_until();
                        })
                    }
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __callback_async_wait_until(
                    event0: u32,
                    event1: u32,
                    event2: u32,
                ) -> u32 {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_async_wait_for_cabi<T: Guest>(arg0: i64) -> i32 {
                    unsafe {
                        #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                        wit_bindgen::rt::async_support::start_task(async move {
                            let _task_cancel = wit_bindgen::rt::async_support::TaskCancelOnDrop::new();
                            ...
                            unsafe extern "C" {
                                ...
                                #[cfg_attr(
                                    target_arch = "wasm32",
                                    link_name = "[task-return][async]wait-for"
                                )]
                                fn X5BexportX5DwasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0X00X5Btask_returnX5DX5BasyncX5Dwait_for();
                            }
                            _task_cancel.forget();
                            X5BexportX5DwasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0X00X5Btask_returnX5DX5BasyncX5Dwait_for();
                        })
                    }
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __callback_async_wait_for(
                    event0: u32,
                    event1: u32,
                    event2: u32,
                ) -> u32 {
                ...
                macro_rules! __export_wasi_clocks_monotonic_clock_0_3_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        _export_async_wait_until_cabi::<$ty > (arg0) } } #[unsafe
                        (export_name = "[callback][async]wait-until")] unsafe extern "C"
                        fn _callback_async_wait_until(event0 : u32, event1 : u32, event2
                        : u32) -> u32 { unsafe { $($path_to_types)*::
                        __callback_async_wait_until(event0, event1, event2) } }
                        #[cfg_attr(target_arch = "wasm32", export_name =
                        "[async]wait-for")] #[cfg_attr(not(target_arch = "wasm32"),
                        no_mangle)] #[allow(non_snake_case)] unsafe extern "C" fn
                        wasiX3AclocksX2Fmonotonic_clockX400X2E3X2E0X00X5BasyncX5Dwait_for(arg0
                        : i64,) -> i32 { unsafe { $($path_to_types)*::
                        _export_async_wait_for_cabi::<$ty > (arg0) } } #[unsafe
                        (export_name = "[callback][async]wait-for")] unsafe extern "C" fn
                        _callback_async_wait_for(event0 : u32, event1 : u32, event2 :
                        u32) -> u32 { unsafe { $($path_to_types)*::
                        __callback_async_wait_for(event0, event1, event2) } } };
                    };
                }
                #[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.43.0:wasi:clocks@0.3.0:exports:encoded world"
)]
#[doc(hidden)]
...
ports\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.235.\
