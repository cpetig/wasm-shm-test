            ...
            unsafe impl _rt::WasmResource for Address {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    unsafe extern "C" {
                        ...
                        fn testX3AshmX2FexchangeX00X5Bresource_dropX5Daddress(_: i32);
                    }
                    unsafe {
                        ...
                        let result6 = match l2 {
                            0 => {
                                let e = {
                                    ...
                                    MemoryArea {
                                        addr: Address::from_handle(l3 as u32),
                                        size: l4 as u32,
                                    }
                                };
                                Ok(e)
            ...
            unsafe impl _rt::WasmResource for Subscriber {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    unsafe extern "C" {
                        ...
                        fn testX3AshmX2Fpub_subX00X5Bresource_dropX5Dsubscriber(_: i32);
                    }
                    unsafe {
            ...
            unsafe impl _rt::WasmResource for Publisher {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    unsafe extern "C" {
                        ...
                        fn testX3AshmX2Fpub_subX00X5Bresource_dropX5Dpublisher(_: i32);
                    }
                    unsafe {
                ...
                pub fn clone(original: &Subscriber) -> Subscriber {
                    unsafe {
                        ...
                        let ret = testX3AshmX2Fpub_subX00X5BstaticX5DsubscriberX2Eclone(
                            (original).handle() as i32,
                        );
                        Subscriber::from_handle(ret as u32)
                    }
                }
            }
            impl Publisher {
                ...
                pub fn new(elements: u32, element_size: Bytes) -> Self {
                    unsafe {
                        ...
                        Publisher::from_handle(ret as u32)
                    }
                }
            }
            impl Publisher {
...
pub mod wit_stream {
    ...
    pub mod vtable0 {
        ...
        #[link(wasm_import_module = "test:shm/pub-sub")]
        unsafe extern "C" {
            #[link_name = "[stream-new-0][method]subscriber.get-stream"]
            fn new() -> u64;
            #[link_name = "[stream-cancel-write-0][method]subscriber.get-stream"]
            fn cancel_write(_: u32) -> u32;
            #[link_name = "[stream-cancel-read-0][method]subscriber.get-stream"]
            fn cancel_read(_: u32) -> u32;
            #[link_name = "[stream-drop-writable-0][method]subscriber.get-stream"]
            fn drop_writable(_: u32);
            #[link_name = "[stream-drop-readable-0][method]subscriber.get-stream"]
            fn drop_readable(_: u32);
            #[link_name = "[async-lower][stream-read-0][method]subscriber.get-stream"]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.44.0:test:shm:client:encoded world"
)]
#[doc(hidden)]
